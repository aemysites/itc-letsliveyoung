...
## Environments
- Preview: https://main--itc-letsliveyoung--aemysites.aem.page/
- Live: https://main--itc-letsliveyoung--aemysites.aem.live/
- Block Library: https://main--itc-letsliveyoung--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-letsliveyoung` directory in your favorite IDE and start coding :)
